    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        for move in game.get_legal_moves():
            current_value = self.min_value(game.forecast_move(move), depth-1)       
...
#        raise                                         
    ...
    def max_value(self, game, depth):
        ...
        value = float("-inf")
        for move in game.get_legal_moves():
        #Find number of moves in each min_node, then return the max value for max_node as a parent node
            current_value = self.min_value(game.forecast_move(move), depth-1)
    ...
    def min_value(self, game, depth):
        ...
        value = float("+inf")
        for move in game.get_legal_moves():
            #Find number of moves in each max_node, then return the min value for min_node as a parent node
            current_value = self.max_value(game.forecast_move(move), depth-1)
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    """
    global depth, alpha, beta, best_move
    def get_move(self, game, time_left):
        """Search for the best move from the available legal moves and return a
        result before the time limit expires.
